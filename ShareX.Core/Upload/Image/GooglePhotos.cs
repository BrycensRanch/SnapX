...
namespace ShareX.Core.Upload.Image
{
    ...
    public sealed class GooglePhotos : ImageUploader, IOAuth2
    {
        ...
        public GooglePhotosAlbum CreateAlbum(string albumName)
        {
            ...
            string serializedNewItemAlbum = JsonSerializer.Serialize(newItemAlbum);
            ...
            GooglePhotosAlbum newItemAlbumResponse = JsonSerializer.Deserialize<GooglePhotosAlbum>(serializedNewItemAlbumResponse);
        ...
        public List<GooglePhotosAlbumInfo> GetAlbumList()
        {
            ...
            do
            {
                ...
                {
                    GooglePhotosAlbums albumsResponse = JsonSerializer.Deserialize<GooglePhotosAlbums>(response);
        ...
        public override UploadResult Upload(Stream stream, string fileName)
        {
            ...
            if (IsPublic)
            {
                ...
                string serializedAlbumOptions = JsonSerializer.Serialize(albumOptions);
                ...
                GooglePhotosAlbumOptionsResponse albumOptionsResponse = JsonSerializer.Deserialize<GooglePhotosAlbumOptionsResponse>(serializedAlbumOptionsResponse);
            ...
            string serializedNewMediaItemRequest = JsonSerializer.Serialize(newMediaItemRequest);
            ...
            GooglePhotosNewMediaItemResults newMediaItemResult = JsonSerializer.Deserialize<GooglePhotosNewMediaItemResults>(result.Response);
